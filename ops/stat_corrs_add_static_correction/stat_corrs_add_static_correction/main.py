...
traces = load_obj(load_var_and_data(get_var_path("apply_stat_corrs__traces_path")))
stat_cors = load_obj(load_var_and_data(get_var_path("apply_stat_corrs__stat_cors_path")))

traces = StatCorsProcessor.apply_stats(traces, stat_cors)

out_obj_path = get_obj_path("apply_stat_corrs__out")
out_var_path = get_var_path("apply_stat_corrs__out")

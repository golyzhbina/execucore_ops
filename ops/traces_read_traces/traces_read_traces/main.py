...
path_to_sgy = load_var_and_data(get_var_path("read_traces__filename"))
normalize = load_var_and_data(get_var_path("read_traces__normalize"))
out_obj_path = get_obj_path("read_traces__out")
out_var_path = get_var_path("read_traces__out")

trace = TracesReader.read_traces(path_to_sgy, normalize)

dump_obj(trace, Path(out_obj_path))

...
from msm_lib.traces import TracesReader, TracesMerger

traces1 = load_obj(load_var_and_data(get_var_path("merge_traces__traces1_path")))
print(traces1)
traces2 = TracesReader.read_traces(
    load_var_and_data(get_var_path("merge_traces__traces2_path")), 
    traces1.is_normalized)

part_size = load_var_and_data(get_var_path("merge_traces__part_size"))

traces = TracesMerger.merge_traces(traces1, traces2, part_size)

out_obj_path = get_obj_path("merge_traces__out")
out_var_path = get_var_path("merge_traces__out")

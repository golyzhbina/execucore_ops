...
veldata_path = load_var_and_data(get_var_path("load_vel_with_deps__filename"))
out_var_path = get_var_path("load_vel_with_deps__out")
out_obj_path = get_obj_path("load_vel_with_deps__out")

veldata = VelocityLoader.get_vel_with_deps(veldata_path)

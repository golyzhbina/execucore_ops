...
from msm_lib.model import ModelCreator
...
veldata = load_obj(veldata_path)
rec_coords = load_obj(rec_coords_path)
region = load_obj(region_path)

velmodel = ModelCreator.create_model(veldata, rec_coords, region, step_vel_model)
dump_obj(velmodel, Path(out_obj_path))

...
detect_function_path_list = load_var_and_data(get_var_path("draw_maxes_at_detect_function__detect_function_path"))
maxes_path_list = load_var_and_data(get_var_path("draw_maxes_at_detect_function__maxes_path"))
out_var_path = get_var_path("draw_maxes_at_detect_function__out")

for i in range(len(detect_function_path_list)):
    try:
        ...
        out_obj_path = get_obj_path("draw_maxes_at_detect_function__out", maxes_path.stem)

...
veldata_path = load_var_and_data(get_var_path("load_vel__filename"))
step_by_depth = load_var_and_data(get_var_path("load_vel__step"))
out_var_path = get_var_path("load_vel__out")
out_obj_path = get_obj_path("load_vel__out")

veldata = VelocityLoader.get_vel(veldata_path, step_by_depth)

...
cube_path = load_var_and_data(get_var_path("get_slice__cube_path"))
maxes_path = load_var_and_data(get_var_path("get_slice__maxes_path"))
...
out_obj_path = get_obj_path("get_slice__out")

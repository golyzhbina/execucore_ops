...
maxes_path = load_var_and_data(get_var_path("draw_tt_at_traces__maxes_path"))
traces_path = load_var_and_data(get_var_path("draw_tt_at_traces__traces_path"))
...
vmin = None #load_var_and_data(get_var_path("draw_tt_at_traces_vmin"))
vmax = None #load_var_and_data(get_var_path("draw_tt_at_traces__vmax"))
out_obj_path = get_obj_path("draw_tt_at_traces__out")

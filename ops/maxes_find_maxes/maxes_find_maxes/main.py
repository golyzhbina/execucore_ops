...
cube_path = load_var_and_data(get_var_path("get_maxes__cube_path"))
detect_function_path = load_var_and_data(get_var_path("get_maxes__detect_function_path"))
region_path = load_var_and_data(get_var_path("get_maxes__region_path"))
out_obj_path = get_obj_path("get_maxes__out")
